  		...
  		<div class="col-xs-12">
  			...
  			<form class="form-horizontal" role="form" name="actionForm" action="/gc/doLogin.do" method="post" style="margin-bottom:20px;">
				...
				<div class="form-group">
					...
					<div class="col-md-4">
						<input  name="passport" id="passport" class="form-control" maxlength="50" placeholder="手机号码或用户名" />
			 	...
			 	<div class="form-group">
					...
					<div class="col-md-4">
						<input  name="password" id="password" type="password" class="form-control" maxlength="50" placeholder="" />
						<span class="help-block"></span>
  			...
  			<div id="tableRow" class="row">
  				<div class="col-xs-12 text-center">
  					 <button type="button" class="btn btn-success" onclick="doLogin()">登&nbsp;录</button>
  					 <span style="display:none" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
  					 <button type="button" class="btn btn-default" onclick="doReg()" style="display:none">注&nbsp;册</button>
  				</div>
  			</div>
